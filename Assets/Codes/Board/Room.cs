...
public class Room
{
    ...
    public int roomWidth;                     // Lebar room (dlm tiles)
    public int roomHeight;                    // Panjang room (dlm tiles)
    ...
    public void SetupRoom (IntRange widthRange, IntRange heightRange, int columns, int rows, Corridor corridor)
    {
        ...
        switch (corridor.direction)
        {
            ...
            case Direction.North:
                ...
                // The y coordinate of the room must be at  theend of the corridor (since the corridor leads to the bottom of the room).
